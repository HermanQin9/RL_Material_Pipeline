...
def test_env_method_mask_shape_and_values():
 ...
 """
 print("[TEST] - Testing method mask shape and values...")
 env = PipelineEnv()
 obs = env.reset()
 ...
 print("✓ - Method mask shape and values test passed")
...
def test_trainer_respects_method_mask_for_single_method_node():
 ...
 print("✓ - Trainer method mask compliance test passed")


if __name__ == "__main__":
 print("\n" + "="*70)
 print("Starting - Starting Method Masking Tests")
 print("="*70 + "\n")
