...
def test_gnn_process_appends_stats():
 ...
 print("SUCCESS GNN / GNN process test passed")
...
def test_kg_process_noop():
 ...
 """
 print("🧪 / Testing KG process...")
 data = _fake_data()
 out = kg_process(data)
 assert out['X_train'].shape == data['X_train'].shape, \
 " / KG process should currently keep data unchanged"
 print("SUCCESS / KG process test passed")


if __name__ == "__main__":
 print("\n" + "="*70)
 print("START GNN / Starting GNN and KG Tests")
 print("="*70 + "\n")
